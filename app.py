...
en  = {
        ...
        'message15':'Press Hash when you are finished recording. We will start recording after the beep',
        ...
        "message17":"Please tell your pincode",
        "message18":"Thank you for telling the pincode"
    }   
...
hi = {
    ...
    "message15": "जब आप रिकॉर्डिंग समाप्त कर लें तो हैश दबाएं। हम बीप के बाद रिकॉर्डिंग शुरू कर देंगे",
    "message16": "\u0905\u092c \u0906\u092a \u0938\u092b\u0932\u0924\u093e\u092a\u0942\u0930\u094d\u0935\u0915 \u092a\u0902\u091c\u0940\u0915\u0943\u0924 \u0939\u094b\u0964 \u0906\u092a \u0905\u092a\u0928\u0947 \u092e\u094b\u092c\u093e\u0907\u0932 \u092b\u094b\u0928 \u092a\u0930 \u0938\u0940\u0927\u0947 \u0938\u092d\u0940 \u0926\u0948\u0928\u093f\u0915 \u0935\u0947\u0924\u0928 \u0905\u0927\u093f\u0938\u0942\u091a\u0928\u093e \u092a\u094d\u0930\u093e\u092a\u094d\u0924 \u0915\u0930\u0947\u0902\u0917\u0947\u0964 \u0905\u0932\u0935\u093f\u0926\u093e",
    "message17":"कृपया अपना पिनकोड बताएं",
    "message18":"पिनकोड बताने के लिए धन्यवाद"
}
...
baseUrl = "http://ce0440f97b4c.ngrok.io"
app = Flask(__name__)
...
def salary(language,age,gender,work):
    ...
    if 'Digits' in request.values:
        ...
        if int(language) == 1:
            ...
            gather = Gather(num_digits=6,action='/pincode/'+language+'/'+age+'/'+gender+'/'+work+'/'+salary)
            response.append(gather)
            return str(response)
        elif int(language) == 2:
            response.say(hi['message13'],voice='Polly.Aditi',language="hi-IN")
            response.say(hi['message17'],voice='Polly.Aditi',language="hi-IN")
            gather = Gather(num_digits=6,action='/pincode/'+language+'/'+age+'/'+gender+'/'+work+'/'+salary)
            response.append(gather)
            return str(response)
        elif int(language) == 3:
            response.say(ka['message13'],voice='Polly.Aditi',language="hi-IN")
            response.say(ka['message17'],voice='Polly.Aditi',language="hi-IN")
            gather = Gather(num_digits=6,action='/pincode/'+language+'/'+age+'/'+gender+'/'+work+'/'+salary)
            response.append(gather)
            return str(response)
        else:
...
# Code - Tested
@app.route('/pincode/<language>/<age>/<gender>/<work>/<salary>',methods=['GET','POST'])
def pincode(language,age,gender,work,salary):
    response = VoiceResponse()
    if 'Digits' in request.values:
        pincode = request.values['Digits']
        if int(language) == 1:
            response.say(en['message18'],voice='Polly.Aditi',language="hi-IN")
            response.say(en['message9'],voice='Polly.Aditi',language="hi-IN")
            response.redirect('/answer/'+language+'/'+age+'/'+gender+'/'+work+'/'+salary+'/'+pincode)
            return str(response)
        elif int(language) == 2:
            response.say(hi['message18'],voice='Polly.Aditi',language="hi-IN")
            response.say(hi['message9'],voice='Polly.Aditi',language="hi-IN")
            response.redirect('/answer/'+language+'/'+age+'/'+gender+'/'+work+'/'+salary+'/'+pincode)
            return str(response)
        elif int(language) == 3:
            response.say(ka['message18'],voice='Polly.Aditi',language="hi-IN")
...
# Code - Tested
@app.route("/answer/<language>/<age>/<gender>/<work>/<salary>/<pincode>", methods=['GET', 'POST'])
def voice(language,age,gender,work,salary,pincode):
    response = VoiceResponse()
    args = request.args
    if 'RecordingUrl' in args:
        ...
        message = client.messages.create(
            body="Thank you for registering for Labour Saathi! We will connect you with contractors soon.",
            from_='+12054489824',
        ...
        action = baseUrl +'/answer/'+language+'/'+age+'/'+gender+'/'+work+'/'+salary + '/' + pincode
        if int(language) == 1:
...
def speakOnCall():
    ...
    fileName = "/home/learner/Desktop/Headout/Hackelite-IVR/XML/data.txt"
    file = open(fileName)
    for i in range(1,4):
        text = file.readline()
...
def getAudio(url):
    ...
    print(fileName)
    urllib.request.urlretrieve(url, '/home/learner/Desktop/Headout/Hackelite-IVR/Recordings/'+fileName+'.wav')
    file_audio = sr.AudioFile('/home/learner/Desktop/Headout/Hackelite-IVR/Recordings/'+fileName+'.wav')
